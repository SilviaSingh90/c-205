...
def rollDice():
    global SERVER
    #create a number variable in whichthe the list of all the ASCII characters of the string will be stored
    #Use blacklash because unicode must  have a blacklash
    diceChoice=['\u2680','\u2681','\u2682','\u2683','\u2683','\u2685']
    ...
    if(playerType == 'player1'):
        ...
        if(playerType == 'player2'):
            SERVER.send(f'{value}playr1Turn'.encode())
